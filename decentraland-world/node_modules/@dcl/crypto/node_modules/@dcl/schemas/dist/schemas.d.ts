...
export declare type AssetBundleConversionManuallyQueuedEvent = BaseEvent & {
    type: Events.Type.ASSET_BUNDLE;
...
export declare type AuthIdentifyEvent = BaseEvent & {
...
export declare type BadgeGrantedEvent = BaseEvent & {
...
export declare type BidEventMetadata = {
    address: string;
    image: string;
    seller: string;
    category: string;
...
export declare namespace BodyPartCategory {
    const schema: JSONSchema<BodyPartCategory>;
    const validate: ValidateFunction<BodyPartCategory>;
}
...
declare type ClientBaseMetadata = {
    authChain: AuthChain;
...
export declare type CommunityDeletedContentViolationEvent = BaseEvent & {
...
export declare namespace CommunityDeletedContentViolationEvent {
    const schema: JSONSchema<CommunityDeletedContentViolationEvent>;
    const validate: ValidateFunction<CommunityDeletedContentViolationEvent>;
}

export declare type CommunityDeletedEvent = BaseEvent & {
    type: Events.Type.COMMUNITY;
...
export declare namespace CommunityDeletedEvent {
    const schema: JSONSchema<CommunityDeletedEvent>;
    const validate: ValidateFunction<CommunityDeletedEvent>;
}

export declare type CommunityInviteReceivedEvent = BaseEvent & {
    type: Events.Type.COMMUNITY;
...
export declare namespace CommunityInviteReceivedEvent {
    const schema: JSONSchema<CommunityInviteReceivedEvent>;
    const validate: ValidateFunction<CommunityInviteReceivedEvent>;
}

export declare type CommunityMemberBannedEvent = BaseEvent & {
    type: Events.Type.COMMUNITY;
...
export declare namespace CommunityMemberBannedEvent {
    const schema: JSONSchema<CommunityMemberBannedEvent>;
    const validate: ValidateFunction<CommunityMemberBannedEvent>;
}

export declare type CommunityMemberLeftEvent = BaseEvent & {
    type: Events.Type.COMMUNITY;
...
export declare namespace CommunityMemberLeftEvent {
    const schema: JSONSchema<CommunityMemberLeftEvent>;
    const validate: ValidateFunction<CommunityMemberLeftEvent>;
}

export declare type CommunityMemberRemovedEvent = BaseEvent & {
    type: Events.Type.COMMUNITY;
...
export declare namespace CommunityMemberRemovedEvent {
    const schema: JSONSchema<CommunityMemberRemovedEvent>;
    const validate: ValidateFunction<CommunityMemberRemovedEvent>;
}

export declare type CommunityOwnershipTransferredEvent = BaseEvent & {
    type: Events.Type.COMMUNITY;
...
export declare namespace CommunityOwnershipTransferredEvent {
    const schema: JSONSchema<CommunityOwnershipTransferredEvent>;
    const validate: ValidateFunction<CommunityOwnershipTransferredEvent>;
}

export declare type CommunityPostAddedEvent = BaseEvent & {
    type: Events.Type.COMMUNITY;
...
export declare namespace CommunityPostAddedEvent {
    const schema: JSONSchema<CommunityPostAddedEvent>;
    const validate: ValidateFunction<CommunityPostAddedEvent>;
}

export declare type CommunityRenamedEvent = BaseEvent & {
    type: Events.Type.COMMUNITY;
...
export declare namespace CommunityRenamedEvent {
    const schema: JSONSchema<CommunityRenamedEvent>;
    const validate: ValidateFunction<CommunityRenamedEvent>;
}

export declare type CommunityRequestToJoinAcceptedEvent = BaseEvent & {
    type: Events.Type.COMMUNITY;
...
export declare namespace CommunityRequestToJoinAcceptedEvent {
    const schema: JSONSchema<CommunityRequestToJoinAcceptedEvent>;
    const validate: ValidateFunction<CommunityRequestToJoinAcceptedEvent>;
}

export declare type CommunityRequestToJoinReceivedEvent = BaseEvent & {
    type: Events.Type.COMMUNITY;
...
export declare namespace CommunityRequestToJoinReceivedEvent {
    const schema: JSONSchema<CommunityRequestToJoinReceivedEvent>;
    const validate: ValidateFunction<CommunityRequestToJoinReceivedEvent>;
}

export declare type CommunityStreamingEndedEvent = BaseEvent & {
...
export declare namespace CommunityStreamingEndedEvent {
    const schema: JSONSchema<CommunityStreamingEndedEvent>;
    const validate: ValidateFunction<CommunityStreamingEndedEvent>;
}

export declare type CommunityVoiceChatStartedEvent = BaseEvent & {
    type: Events.Type.COMMUNITY;
...
export declare namespace CommunityVoiceChatStartedEvent {
    const schema: JSONSchema<CommunityVoiceChatStartedEvent>;
    const validate: ValidateFunction<CommunityVoiceChatStartedEvent>;
}
...
export declare type CreditsClaimReminderEvent = BaseEvent & {
...
export declare type CreditsCompleteGoalsReminderEvent = BaseEvent & {
    type: Events.Type.CREDITS_SERVICE;
...
export declare type CreditsDoNotMissOutReminderEvent = BaseEvent & {
    type: Events.Type.CREDITS_SERVICE;
...
export declare type CreditsGoalCompletedEvent = BaseEvent & {
    type: Events.Type.CREDITS_SERVICE;
...
export declare type CreditsNewSeasonReminderEvent = BaseEvent & {
    type: Events.Type.CREDITS_SERVICE;
...
export declare namespace CreditsNewSeasonReminderEvent {
    const schema: JSONSchema<CreditsNewSeasonReminderEvent>;
    const validate: ValidateFunction<CreditsNewSeasonReminderEvent>;
}

export declare type CreditsOnDemandEvent = BaseEvent & {
    type: Events.Type.CREDITS_SERVICE;
...
export declare namespace CreditsOnDemandEvent {
    const schema: JSONSchema<CreditsOnDemandEvent>;
    const validate: ValidateFunction<CreditsOnDemandEvent>;
}

export declare type CreditsUsage24HoursReminderEvent = BaseEvent & {
    type: Events.Type.CREDITS_SERVICE;
...
export declare type CreditsUsageReminderEvent = BaseEvent & {
    type: Events.Type.CREDITS_SERVICE;
...
export declare type EmoteEvents = {
...
export declare type EventEndedEvent = BaseEvent & {
    type: Events.Type.EVENT;
...
export declare namespace EventEndedEvent {
    const schema: JSONSchema<EventEndedEvent>;
    const validate: ValidateFunction<EventEndedEvent>;
}
...
export declare type FriendshipAcceptedEvent = BaseEvent & {
...
export declare type FriendshipRequestEvent = BaseEvent & {
    type: Events.Type.SOCIAL_SERVICE;
...
export declare namespace LinkerAuthorization {
    const schema: JSONSchema<LinkerAuthorization>;
    const validate: ValidateFunction<LinkerAuthorization>;
}
...
export declare type LoggedInCachedEvent = BaseEvent & {
...
export declare type LoggedInEvent = BaseEvent & {
    type: Events.Type.CLIENT;
 ...
 * @alpha
 */
export declare enum NotificationOptOutScope {
    COMMUNITY = "community"
}
...
export declare type PhotoPrivacyChangedEvent = BaseEvent & {
...
export declare namespace PhotoPrivacyChangedEvent {
    const schema: JSONSchema<PhotoPrivacyChangedEvent>;
    const validate: ValidateFunction<PhotoPrivacyChangedEvent>;
}

export declare type PhotoTakenEvent = BaseEvent & {
    type: Events.Type.CAMERA;
...
export declare namespace PhotoTakenEvent {
    const schema: JSONSchema<PhotoTakenEvent>;
    const validate: ValidateFunction<PhotoTakenEvent>;
}
...
export declare type PreviewMessagePayload<T extends PreviewMessageType> = T extends PreviewMessageType.READY ? null : T extends PreviewMessageType.LOAD ? {
...
export declare enum PreviewRenderer {
    BABYLON = "babylon",
    UNITY = "unity"
}
...
export declare enum PreviewUnityMode {
    AUTH = "authentication",
    BUILDER = "builder",
    MARKETPLACE = "marketplace",
    PROFILE = "profile",
...
export declare type ReferralInvitedUsersAcceptedEvent = BaseEvent & {
    type: Events.Type.REFERRAL;
    subType: Events.SubType.Referral.REFERRAL_INVITED_USERS_ACCEPTED;
    metadata: ReferralMetadata;
};

export declare namespace ReferralInvitedUsersAcceptedEvent {
    const schema: JSONSchema<ReferralInvitedUsersAcceptedEvent>;
    const validate: ValidateFunction<ReferralInvitedUsersAcceptedEvent>;
}

declare type ReferralMetadata = {
    title: string;
    description: string;
    address: string;
    tier: number;
...
export declare type ReferralNewTierReachedEvent = BaseEvent & {
    type: Events.Type.REFERRAL;
    subType: Events.SubType.Referral.REFERRAL_NEW_TIER_REACHED;
    metadata: ReferralMetadata;
};

export declare namespace ReferralNewTierReachedEvent {
    const schema: JSONSchema<ReferralNewTierReachedEvent>;
    const validate: ValidateFunction<ReferralNewTierReachedEvent>;
}
...
declare type SocialEmoteAnimation = {
    title: string;
    loop: boolean;
    audio?: string;
} & {
...
/** @alpha */
export declare type SpringBoneParams = {
    stiffness: number;
    gravityPower: number;
...
export declare type StreamingKeyExpiredEvent = BaseEvent & {
    type: Events.Type.STREAMING;
...
export declare type StreamingKeyResetEvent = BaseEvent & {
    type: Events.Type.STREAMING;
...
export declare type StreamingKeyRevokeEvent = BaseEvent & {
    type: Events.Type.STREAMING;
...
declare type StreamingMetadata = {
    title: string;
    description: string;
    position: string;
...
export declare type StreamingPlaceUpdatedEvent = BaseEvent & {
    type: Events.Type.STREAMING;
...
export declare type StreamingTimeExceededEvent = BaseEvent & {
    type: Events.Type.STREAMING;
...
export declare type TipReceivedEvent = BaseEvent & {
    type: Events.Type.BLOCKCHAIN;
...
export declare namespace TipReceivedEvent {
    const schema: JSONSchema<TipReceivedEvent>;
    const validate: ValidateFunction<TipReceivedEvent>;
}
...
export declare type TradeCreation = {
    signer: string;
    signature: string;
    network: Network;
    chainId: ChainId;
...
export declare type TransferReceivedEvent = BaseEvent & {
    type: Events.Type.BLOCKCHAIN;
...
export declare namespace TransferReceivedEvent {
    const schema: JSONSchema<TransferReceivedEvent>;
    const validate: ValidateFunction<TransferReceivedEvent>;
}
...
export declare type UsedEmoteEvent = BaseEvent & {
    type: Events.Type.CLIENT;
...
export declare type UserBanCreatedEvent = BaseEvent & {
...
export declare namespace UserBanCreatedEvent {
    const schema: JSONSchema<UserBanCreatedEvent>;
    const validate: ValidateFunction<UserBanCreatedEvent>;
}

export declare type UserBanLiftedEvent = BaseEvent & {
    type: Events.Type.MODERATION;
...
export declare namespace UserBanLiftedEvent {
    const schema: JSONSchema<UserBanLiftedEvent>;
    const validate: ValidateFunction<UserBanLiftedEvent>;
}

export declare type UserBannedFromSceneEvent = BaseEvent & {
...
export declare namespace UserBannedFromSceneEvent {
    const schema: JSONSchema<UserBannedFromSceneEvent>;
    const validate: ValidateFunction<UserBannedFromSceneEvent>;
}

export declare type UserJoinedRoomEvent = BaseEvent & {
    type: Events.Type.COMMS;
...
export declare namespace UserJoinedRoomEvent {
    const schema: JSONSchema<UserJoinedRoomEvent>;
    const validate: ValidateFunction<UserJoinedRoomEvent>;
}

export declare type UserLeftRoomEvent = BaseEvent & {
    type: Events.Type.COMMS;
...
export declare namespace UserLeftRoomEvent {
    const schema: JSONSchema<UserLeftRoomEvent>;
    const validate: ValidateFunction<UserLeftRoomEvent>;
}

export declare type UserUnbannedFromSceneEvent = BaseEvent & {
    type: Events.Type.COMMS;
...
export declare namespace UserUnbannedFromSceneEvent {
    const schema: JSONSchema<UserUnbannedFromSceneEvent>;
    const validate: ValidateFunction<UserUnbannedFromSceneEvent>;
}

export declare type UserWarningCreatedEvent = BaseEvent & {
    type: Events.Type.MODERATION;
...
export declare namespace UserWarningCreatedEvent {
    const schema: JSONSchema<UserWarningCreatedEvent>;
    const validate: ValidateFunction<UserWarningCreatedEvent>;
}
...
export declare type VerticalHeightReachedEvent = BaseEvent & {
    type: Events.Type.CLIENT;
...
export declare type WalkedDistanceEvent = BaseEvent & {
    type: Events.Type.CLIENT;
...
export declare type WebBaseMetadata = {
    userAgent: string;
    ip: string;
    pagePath: string;
    pageUrl: string;
...
export declare type WorldDeploymentEvent = BaseEvent & {
...
export declare namespace WorldDeploymentEvent {
    const schema: JSONSchema<WorldDeploymentEvent>;
    const validate: ValidateFunction<WorldDeploymentEvent>;
}
...
export declare type WorldScenesUndeploymentEvent = BaseEvent & {
    type: Events.Type.WORLD;
...
export declare namespace WorldScenesUndeploymentEvent {
    const schema: JSONSchema<WorldScenesUndeploymentEvent>;
    const validate: ValidateFunction<WorldScenesUndeploymentEvent>;
}

export declare type WorldSettingsChangedEvent = BaseEvent & {
    type: Events.Type.WORLD;
...
export declare namespace WorldSettingsChangedEvent {
    const schema: JSONSchema<WorldSettingsChangedEvent>;
}
...
export declare type WorldSpawnCoordinateSetEvent = BaseEvent & {
    type: Events.Type.WORLD;
...
export declare namespace WorldSpawnCoordinateSetEvent {
    const schema: JSONSchema<WorldSpawnCoordinateSetEvent>;
    const validate: ValidateFunction<WorldSpawnCoordinateSetEvent>;
}
...
export declare type WorldUndeploymentEvent = BaseEvent & {
    type: Events.Type.WORLD;
...
export declare namespace WorldUndeploymentEvent {
    const schema: JSONSchema<WorldUndeploymentEvent>;
    const validate: ValidateFunction<WorldUndeploymentEvent>;
}
