...
import { AvatarMask } from "../../sdk/components/common/avatar_mask.gen";
...
export declare enum OpenExplorerUiResult {
    UNSPECIFIED = 0,
    OPENED = 1,
...
export declare function openExplorerUiResultFromJSON(object: any): OpenExplorerUiResult;
export declare function openExplorerUiResultToJSON(object: OpenExplorerUiResult): string;
...
export declare namespace MovePlayerToResponse {
    function encode(message: MovePlayerToResponse, writer?: _m0.Writer): _m0.Writer;
    function decode(input: _m0.Reader | Uint8Array, length?: number): MovePlayerToResponse;
    function fromJSON(object: any): MovePlayerToResponse;
    function toJSON(message: MovePlayerToResponse): unknown;
...
export declare namespace CopyToClipboardRequest {
    ...
    function fromJSON(object: any): CopyToClipboardRequest;
    function toJSON(message: CopyToClipboardRequest): unknown;
    function create<I extends Exact<DeepPartial<CopyToClipboardRequest>, I>>(base?: I): CopyToClipboardRequest;
    function fromPartial<I extends Exact<DeepPartial<CopyToClipboardRequest>, I>>(object: I): CopyToClipboardRequest;
}
export declare namespace EmptyResponse {
    function encode(_: EmptyResponse, writer?: _m0.Writer): _m0.Writer;
    function decode(input: _m0.Reader | Uint8Array, length?: number): EmptyResponse;
    function fromJSON(_: any): EmptyResponse;
    function toJSON(_: EmptyResponse): unknown;
...
export declare namespace OpenExplorerUiRequest {
    function encode(message: OpenExplorerUiRequest, writer?: _m0.Writer): _m0.Writer;
    function decode(input: _m0.Reader | Uint8Array, length?: number): OpenExplorerUiRequest;
    function fromJSON(object: any): OpenExplorerUiRequest;
    function toJSON(message: OpenExplorerUiRequest): unknown;
    function create<I extends Exact<DeepPartial<OpenExplorerUiRequest>, I>>(base?: I): OpenExplorerUiRequest;
    function fromPartial<I extends Exact<DeepPartial<OpenExplorerUiRequest>, I>>(object: I): OpenExplorerUiRequest;
}
export declare namespace OpenExplorerUiResponse {
    function encode(message: OpenExplorerUiResponse, writer?: _m0.Writer): _m0.Writer;
    function decode(input: _m0.Reader | Uint8Array, length?: number): OpenExplorerUiResponse;
    function fromJSON(object: any): OpenExplorerUiResponse;
    function toJSON(message: OpenExplorerUiResponse): unknown;
    function create<I extends Exact<DeepPartial<OpenExplorerUiResponse>, I>>(base?: I): OpenExplorerUiResponse;
    function fromPartial<I extends Exact<DeepPartial<OpenExplorerUiResponse>, I>>(object: I): OpenExplorerUiResponse;
}
...
export declare const RestrictedActionsServiceDefinition: {
    ...
    readonly methods: {
        ...
        readonly copyToClipboard: {
            ...
            readonly requestType: typeof CopyToClipboardRequest;
            readonly requestStream: false;
            readonly responseType: typeof EmptyResponse;
            readonly responseStream: false;
            readonly options: {};
        };
        ...
        readonly openExplorerUi: {
            readonly name: "OpenExplorerUi";
            readonly requestType: typeof OpenExplorerUiRequest;
            readonly requestStream: false;
            readonly responseType: typeof OpenExplorerUiResponse;
            readonly responseStream: false;
            readonly options: {};
        };
    };
