...
exports.RestrictedActionsServiceDefinition = exports.OpenExplorerUiResponse = exports.OpenExplorerUiRequest = exports.StopEmoteRequest = exports.EmptyResponse = exports.CopyToClipboardRequest = exports.TeleportToResponse = exports.MovePlayerToResponse = exports.TriggerEmoteResponse = exports.SuccessResponse = exports.TriggerSceneEmoteRequest = exports.CommsAdapterRequest = exports.UnblockPointerRequest = exports.OpenNftDialogRequest = exports.OpenExternalUrlRequest = exports.ChangeRealmRequest = exports.TriggerEmoteRequest = exports.TeleportToRequest = exports.MovePlayerToRequest = exports.OpenExplorerUiResult = exports.protobufPackage = void 0;
exports.openExplorerUiResultFromJSON = openExplorerUiResultFromJSON;
exports.openExplorerUiResultToJSON = openExplorerUiResultToJSON;
/* eslint-disable */
const minimal_1 = __importDefault(require("protobufjs/minimal"));
const vectors_gen_1 = require("../../common/vectors.gen");
const avatar_mask_gen_1 = require("../../sdk/components/common/avatar_mask.gen");
const explorer_ui_gen_1 = require("../../sdk/components/common/explorer_ui.gen");
...
var OpenExplorerUiResult;
(function (OpenExplorerUiResult) {
    OpenExplorerUiResult[OpenExplorerUiResult["UNSPECIFIED"] = 0] = "UNSPECIFIED";
    OpenExplorerUiResult[OpenExplorerUiResult["OPENED"] = 1] = "OPENED";
    /** WAS_ALREADY_OPEN - a fullscreen panel is already open */
    OpenExplorerUiResult[OpenExplorerUiResult["WAS_ALREADY_OPEN"] = 2] = "WAS_ALREADY_OPEN";
    /** REJECTED_NOT_CURRENT_SCENE - the standard restricted-actions current-scene gate rejected the call */
    OpenExplorerUiResult[OpenExplorerUiResult["REJECTED_NOT_CURRENT_SCENE"] = 3] = "REJECTED_NOT_CURRENT_SCENE";
    /** REJECTED_FEATURE_DISABLED - the requested section is hidden by feature flags or client doesn't have that feature */
    OpenExplorerUiResult[OpenExplorerUiResult["REJECTED_FEATURE_DISABLED"] = 4] = "REJECTED_FEATURE_DISABLED";
    /** REJECTED_NO_USER_GESTURE - rejected: the call did not originate from a user gesture */
    OpenExplorerUiResult[OpenExplorerUiResult["REJECTED_NO_USER_GESTURE"] = 5] = "REJECTED_NO_USER_GESTURE";
    OpenExplorerUiResult[OpenExplorerUiResult["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(OpenExplorerUiResult || (exports.OpenExplorerUiResult = OpenExplorerUiResult = {}));
function openExplorerUiResultFromJSON(object) {
    switch (object) {
        case 0:
        case "UNSPECIFIED":
            return OpenExplorerUiResult.UNSPECIFIED;
        case 1:
        case "OPENED":
            return OpenExplorerUiResult.OPENED;
        case 2:
        case "WAS_ALREADY_OPEN":
            return OpenExplorerUiResult.WAS_ALREADY_OPEN;
        case 3:
        case "REJECTED_NOT_CURRENT_SCENE":
            return OpenExplorerUiResult.REJECTED_NOT_CURRENT_SCENE;
        case 4:
        case "REJECTED_FEATURE_DISABLED":
            return OpenExplorerUiResult.REJECTED_FEATURE_DISABLED;
        case 5:
        case "REJECTED_NO_USER_GESTURE":
            return OpenExplorerUiResult.REJECTED_NO_USER_GESTURE;
        case -1:
        case "UNRECOGNIZED":
        default:
            return OpenExplorerUiResult.UNRECOGNIZED;
    }
}
function openExplorerUiResultToJSON(object) {
    switch (object) {
        case OpenExplorerUiResult.UNSPECIFIED:
            return "UNSPECIFIED";
        case OpenExplorerUiResult.OPENED:
            return "OPENED";
        case OpenExplorerUiResult.WAS_ALREADY_OPEN:
            return "WAS_ALREADY_OPEN";
        case OpenExplorerUiResult.REJECTED_NOT_CURRENT_SCENE:
            return "REJECTED_NOT_CURRENT_SCENE";
        case OpenExplorerUiResult.REJECTED_FEATURE_DISABLED:
            return "REJECTED_FEATURE_DISABLED";
        case OpenExplorerUiResult.REJECTED_NO_USER_GESTURE:
            return "REJECTED_NO_USER_GESTURE";
        case OpenExplorerUiResult.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
(function (MovePlayerToRequest) {
    function encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.avatarTarget !== undefined) {
            vectors_gen_1.Vector3.encode(message.avatarTarget, writer.uint32(26).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    message.avatarTarget = vectors_gen_1.Vector3.decode(reader, reader.uint32());
                    continue;
                case 4:
                    if (tag !== 37) {
                        break;
    ...
    function fromJSON(object) {
        return {
            ...
            avatarTarget: isSet(object.avatarTarget) ? vectors_gen_1.Vector3.fromJSON(object.avatarTarget) : undefined,
    ...
    function toJSON(message) {
        ...
        message.avatarTarget !== undefined &&
            (obj.avatarTarget = message.avatarTarget ? vectors_gen_1.Vector3.toJSON(message.avatarTarget) : undefined);
    ...
    function fromPartial(object) {
        ...
        message.avatarTarget = (object.avatarTarget !== undefined && object.avatarTarget !== null)
            ? vectors_gen_1.Vector3.fromPartial(object.avatarTarget)
            : undefined;
        message.duration = (_a = object.duration) !== null && _a !== void 0 ? _a : undefined;
        return message;
    }
...
(function (TriggerEmoteRequest) {
    ...
    function fromJSON(object) {
        return {
            ...
            mask: isSet(object.mask) ? (0, avatar_mask_gen_1.avatarMaskFromJSON)(object.mask) : undefined,
        };
    }
    ...
    function toJSON(message) {
        ...
        message.mask !== undefined && (obj.mask = message.mask !== undefined ? (0, avatar_mask_gen_1.avatarMaskToJSON)(message.mask) : undefined);
        return obj;
    }
...
(function (CopyToClipboardRequest) {
    function encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.text !== "") {
    ...
    CopyToClipboardRequest.encode = encode;
    function decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : minimal_1.default.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
    ...
    CopyToClipboardRequest.decode = decode;
    function fromJSON(object) {
        return { text: isSet(object.text) ? String(object.text) : "" };
    }
    CopyToClipboardRequest.fromJSON = fromJSON;
    function toJSON(message) {
        const obj = {};
        message.text !== undefined && (obj.text = message.text);
        return obj;
    }
    CopyToClipboardRequest.toJSON = toJSON;
    function create(base) {
        return CopyToClipboardRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    }
    CopyToClipboardRequest.create = create;
    function fromPartial(object) {
        var _a;
        const message = createBaseCopyToClipboardRequest();
    ...
    CopyToClipboardRequest.fromPartial = fromPartial;
})(CopyToClipboardRequest || (exports.CopyToClipboardRequest = CopyToClipboardRequest = {}));
...
(function (EmptyResponse) {
    ...
    EmptyResponse.decode = decode;
    function fromJSON(_) {
        return {};
    }
    EmptyResponse.fromJSON = fromJSON;
    function toJSON(_) {
        const obj = {};
        return obj;
    }
    EmptyResponse.toJSON = toJSON;
    function create(base) {
        return EmptyResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    }
    EmptyResponse.create = create;
    function fromPartial(_) {
        const message = createBaseEmptyResponse();
        return message;
    }
...
function createBaseOpenExplorerUiRequest() {
    return { ui: 0 };
}
var OpenExplorerUiRequest;
(function (OpenExplorerUiRequest) {
    function encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.ui !== 0) {
    ...
    OpenExplorerUiRequest.encode = encode;
    function decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : minimal_1.default.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseOpenExplorerUiRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    OpenExplorerUiRequest.decode = decode;
    function fromJSON(object) {
        return { ui: isSet(object.ui) ? (0, explorer_ui_gen_1.explorerUiFromJSON)(object.ui) : 0 };
    }
    OpenExplorerUiRequest.fromJSON = fromJSON;
    function toJSON(message) {
        const obj = {};
        message.ui !== undefined && (obj.ui = (0, explorer_ui_gen_1.explorerUiToJSON)(message.ui));
        return obj;
    }
    OpenExplorerUiRequest.toJSON = toJSON;
    function create(base) {
        return OpenExplorerUiRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    }
    OpenExplorerUiRequest.create = create;
    function fromPartial(object) {
        var _a;
        const message = createBaseOpenExplorerUiRequest();
        message.ui = (_a = object.ui) !== null && _a !== void 0 ? _a : 0;
        return message;
    }
    OpenExplorerUiRequest.fromPartial = fromPartial;
})(OpenExplorerUiRequest || (exports.OpenExplorerUiRequest = OpenExplorerUiRequest = {}));
function createBaseOpenExplorerUiResponse() {
    return { openResult: 0 };
}
var OpenExplorerUiResponse;
(function (OpenExplorerUiResponse) {
    function encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.openResult !== 0) {
            writer.uint32(8).int32(message.openResult);
        }
        return writer;
    }
    OpenExplorerUiResponse.encode = encode;
    function decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : minimal_1.default.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseOpenExplorerUiResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.openResult = reader.int32();
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    OpenExplorerUiResponse.decode = decode;
    function fromJSON(object) {
        return { openResult: isSet(object.openResult) ? openExplorerUiResultFromJSON(object.openResult) : 0 };
    }
    OpenExplorerUiResponse.fromJSON = fromJSON;
    function toJSON(message) {
        const obj = {};
        message.openResult !== undefined && (obj.openResult = openExplorerUiResultToJSON(message.openResult));
        return obj;
    }
    OpenExplorerUiResponse.toJSON = toJSON;
    function create(base) {
        return OpenExplorerUiResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    }
    OpenExplorerUiResponse.create = create;
    function fromPartial(object) {
        var _a;
        const message = createBaseOpenExplorerUiResponse();
        message.openResult = (_a = object.openResult) !== null && _a !== void 0 ? _a : 0;
        return message;
    }
    OpenExplorerUiResponse.fromPartial = fromPartial;
})(OpenExplorerUiResponse || (exports.OpenExplorerUiResponse = OpenExplorerUiResponse = {}));
exports.RestrictedActionsServiceDefinition = {
    ...
    methods: {
        ...
        openExplorerUi: {
            name: "OpenExplorerUi",
            requestType: OpenExplorerUiRequest,
            requestStream: false,
            responseType: OpenExplorerUiResponse,
            responseStream: false,
            options: {},
        },
    },
