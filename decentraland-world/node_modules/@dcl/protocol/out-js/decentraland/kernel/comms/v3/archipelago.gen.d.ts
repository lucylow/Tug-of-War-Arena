...
export declare namespace ServiceStatus {
    function encode(message: ServiceStatus, writer?: _m0.Writer): _m0.Writer;
    function decode(input: _m0.Reader | Uint8Array, length?: number): ServiceStatus;
    function fromJSON(object: any): ServiceStatus;
    function toJSON(message: ServiceStatus): unknown;
    function create<I extends Exact<DeepPartial<ServiceStatus>, I>>(base?: I): ServiceStatus;
    function fromPartial<I extends Exact<DeepPartial<ServiceStatus>, I>>(object: I): ServiceStatus;
}
export declare namespace ServiceDiscoveryMessage {
    function encode(message: ServiceDiscoveryMessage, writer?: _m0.Writer): _m0.Writer;
    function decode(input: _m0.Reader | Uint8Array, length?: number): ServiceDiscoveryMessage;
    function fromJSON(object: any): ServiceDiscoveryMessage;
    function toJSON(message: ServiceDiscoveryMessage): unknown;
    function create<I extends Exact<DeepPartial<ServiceDiscoveryMessage>, I>>(base?: I): ServiceDiscoveryMessage;
    function fromPartial<I extends Exact<DeepPartial<ServiceDiscoveryMessage>, I>>(object: I): ServiceDiscoveryMessage;
}
