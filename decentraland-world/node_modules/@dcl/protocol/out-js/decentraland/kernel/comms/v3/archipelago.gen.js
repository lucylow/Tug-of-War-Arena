...
exports.ServiceDiscoveryMessage = exports.ServiceStatus = exports.IslandStatusMessage = exports.IslandData = exports.ClientPacket = exports.Heartbeat = exports.SignedChallengeMessage = exports.ChallengeRequestMessage = exports.ServerPacket = exports.KickedMessage = exports.JoinIslandMessage = exports.LeftIslandMessage = exports.IslandChangedMessage_PeersEntry = exports.IslandChangedMessage = exports.WelcomeMessage = exports.ChallengeResponseMessage = exports.KickedReason = exports.protobufPackage = void 0;
...
function createBaseServiceStatus() {
    return { currentTime: 0, commitHash: undefined, userCount: 0 };
}
var ServiceStatus;
(function (ServiceStatus) {
    function encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.currentTime !== 0) {
            writer.uint32(8).uint64(message.currentTime);
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.currentTime = longToNumber(reader.uint64());
                    continue;
                case 2:
                    if (tag !== 18) {
                        break;
    ...
    ServiceStatus.fromJSON = fromJSON;
    function toJSON(message) {
        const obj = {};
    ...
    ServiceStatus.toJSON = toJSON;
    function create(base) {
        return ServiceStatus.fromPartial(base !== null && base !== void 0 ? base : {});
    }
    ServiceStatus.create = create;
    function fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseServiceStatus();
        message.currentTime = (_a = object.currentTime) !== null && _a !== void 0 ? _a : 0;
        message.commitHash = (_b = object.commitHash) !== null && _b !== void 0 ? _b : undefined;
        message.userCount = (_c = object.userCount) !== null && _c !== void 0 ? _c : 0;
        return message;
    }
    ServiceStatus.fromPartial = fromPartial;
})(ServiceStatus || (exports.ServiceStatus = ServiceStatus = {}));
function createBaseServiceDiscoveryMessage() {
    return { serverName: "", status: undefined };
}
var ServiceDiscoveryMessage;
(function (ServiceDiscoveryMessage) {
    function encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.serverName !== "") {
            writer.uint32(10).string(message.serverName);
        }
        if (message.status !== undefined) {
            ServiceStatus.encode(message.status, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    }
    ServiceDiscoveryMessage.encode = encode;
    function decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : minimal_1.default.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseServiceDiscoveryMessage();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    ServiceDiscoveryMessage.decode = decode;
    function fromJSON(object) {
        return {
            serverName: isSet(object.serverName) ? String(object.serverName) : "",
            status: isSet(object.status) ? ServiceStatus.fromJSON(object.status) : undefined,
        };
    }
    ServiceDiscoveryMessage.fromJSON = fromJSON;
    function toJSON(message) {
        const obj = {};
        message.serverName !== undefined && (obj.serverName = message.serverName);
        message.status !== undefined && (obj.status = message.status ? ServiceStatus.toJSON(message.status) : undefined);
        return obj;
    }
    ServiceDiscoveryMessage.toJSON = toJSON;
    function create(base) {
        return ServiceDiscoveryMessage.fromPartial(base !== null && base !== void 0 ? base : {});
    }
    ServiceDiscoveryMessage.create = create;
    function fromPartial(object) {
        var _a;
        const message = createBaseServiceDiscoveryMessage();
    ...
    ServiceDiscoveryMessage.fromPartial = fromPartial;
})(ServiceDiscoveryMessage || (exports.ServiceDiscoveryMessage = ServiceDiscoveryMessage = {}));
