...
export namespace ServiceStatus {
  export function encode(message: ServiceStatus, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  export function decode(input: _m0.Reader | Uint8Array, length?: number): ServiceStatus {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  export function fromJSON(object: any): ServiceStatus {
    return {
  ...
  export function toJSON(message: ServiceStatus): unknown {
    const obj: any = {};
  ...
  export function create<I extends Exact<DeepPartial<ServiceStatus>, I>>(base?: I): ServiceStatus {
    return ServiceStatus.fromPartial(base ?? {});
  }

  export function fromPartial<I extends Exact<DeepPartial<ServiceStatus>, I>>(object: I): ServiceStatus {
    const message = createBaseServiceStatus();
...
function createBaseServiceDiscoveryMessage(): ServiceDiscoveryMessage {
  return { serverName: "", status: undefined };
}

export namespace ServiceDiscoveryMessage {
  export function encode(message: ServiceDiscoveryMessage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  export function decode(input: _m0.Reader | Uint8Array, length?: number): ServiceDiscoveryMessage {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  export function fromJSON(object: any): ServiceDiscoveryMessage {
    return {
  ...
  export function toJSON(message: ServiceDiscoveryMessage): unknown {
    const obj: any = {};
  ...
  export function create<I extends Exact<DeepPartial<ServiceDiscoveryMessage>, I>>(base?: I): ServiceDiscoveryMessage {
    return ServiceDiscoveryMessage.fromPartial(base ?? {});
  }

  export function fromPartial<I extends Exact<DeepPartial<ServiceDiscoveryMessage>, I>>(
    object: I,
