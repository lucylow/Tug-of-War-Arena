...
exports.setUpManager = exports.createQuestByPrompting = exports.urlRegex = void 0;
...
const prompts_1 = __importDefault(require("../../logic/prompts"));
...
const createQuestByPrompting = async (_components) => {
    ...
    const { definition: rawDefinition } = await (0, prompts_1.default)({
        type: 'text',
        name: 'definition',
