...
async function getAllComposites(components, workingDirectory) {
    ...
    const watchFiles = (0, fs_1.globSync)('**/*.composite', { cwd: workingDirectory });
