...
export declare const b64ContentVersionedHashingFunction: (str: string, mtimeMs: number) => string;
export declare const b64HashDecodingFunction: (hash: string) => string;
